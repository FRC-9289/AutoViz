...
static constexpr auto qt_meta_stringdata_ZN5RobotE = QtMocHelpers::stringData(
    "Robot"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN5RobotE[] = {
...
Q_CONSTINIT const QMetaObject Robot::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN5RobotE.offsetsAndSizes,
    qt_meta_data_ZN5RobotE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN5RobotE_t,
        // Q_OBJECT / Q_GADGET
...
void *Robot::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN5RobotE.stringdata0))
